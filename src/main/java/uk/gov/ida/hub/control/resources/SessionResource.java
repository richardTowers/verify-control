...
public class SessionResource {
    ...
    public Response getIdpAuthnRequestFromHub(@PathParam("sessionId") String sessionId) throws SessionNotFoundException {
    ...
    public Response receiveIdpAuthnResponse(
        @PathParam("sessionId") String sessionId,
        Map<String, String> samlResponse
    ) throws SessionNotFoundException, ApiBadRequestException, ConditionNotMetException, IdpDisabledException {
